...
*  Accessing workflow specification
  - (old) +my_instance.workflow+
  - (new) +MyClass.workflow_spec+

* Accessing states, events, meta, e.g.
  - (old) +my_instance.workflow.states(:some_state).events(:some_event).meta[:some_meta_tag]+
  - (new) +MyClass.workflow_spec.states[:some_state].events[:some_event].meta[:some_meta_tag]+

* Causing state transitions
  - (old) +my_instance.workflow.my_event+
  - (new) +my_instance.my_event!+
