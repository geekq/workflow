[![Build Status](https://travis-ci.org/geekq/workflow.png?branch=1-2-stable)](https://travis-ci.org/geekq/workflow) Tested with [different Ruby and Rails versions](https://travis-ci.org/geekq/workflow)

Note: this 1.2 stable branch/version supports only the older Ruby/Rails versions
including Rails 2.3 and (with some limitations in persistence logic) Rails 3.*
